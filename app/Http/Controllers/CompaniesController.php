...
class CompaniesController extends Controller
{
    ...
    public function validator($data){
        return Validator::make($data,[
            ...
            'state'=>['required'],
            'representative_name'=>['required','string','max:450'],
            'representative_marital_status'=>['required'],
            'representative_occupation'=>['required','string','max:450'],
            'representative_rg'=>['required','string','max:450'],
            'representative_cpf'=>['required','cpf','max:14'],
            'representative_street'=>['required','string','max:450'],
            'representative_number'=>['required','string','max:50'],
            'representative_complement'=>['string','max:450'],
            'representative_cep'=>['required','string','regex:/([0-9]{5})\-([0-9]{3})/'],
            'representative_neighborhood'=>['required','string','max:450'],
            'representative_city'=>['required','string','max:450'],
            'representative_state'=>['required'],
    ...
    private function msgCompanies(){
        return [
            ...
            'representative_name.required'=>'o campo nome do representante é obrigatório',
            ...
            'representative_marital_status.required'=>'o campo estado cívil do representante é obrigatório',
            ...
            'representative_cpf.required'=>'o campo cnpj do representante é obrigatório',
            'representative_cpf.cpf'=>'o cpf do representante está inválido',
            'representative_street.required'=>'o campo rua do representante  é obrigatório',
            ...
            'representative_number.required'=>'o campo numero do representante é obrigatório',
            ...
            'representative_cep.required'=>'o campo cep do representante é obrigatório',
